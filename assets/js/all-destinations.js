document.addEventListener('DOMContentLoaded', () => {
    ...
    // REEMPLAZA TU ARRAY CON ESTE (YA ESTÁ CORREGIDO)
const allDestinationsData = [
    // === Ica y Huacachina ===
    {
        name: 'Dune Buggy & Sandboard',
        category: 'Ica y Huacachina',
        url: 'pages/tour/Coast-of-Peru/Ica-y-Huacachina/tourDuneBuggySandboardFalta.html',
        image: 'assets/img/Costa/Ica_Huaca/Buggy_TourySandboard/tourBuggy.jpg',
    },
    {
        name: 'Tour de Viñedo, Museo y Oasis',
        category: 'Ica y Huacachina',
        url: 'pages/tour/Coast-of-Peru/Ica-y-Huacachina/tourVineyardMuseumOasisTour.html',
    ...
    // === Lima ===
    {
        name: 'Tour a Caral',
        category: 'Lima',
        url: 'pages/tour/Coast-of-Peru/Lima/tourCaral.html',
        image: 'assets/img/Costa/tours_Lima/Caral/tourCaral.jpg'
    },
    {
        name: 'Sobrevuelo a las Líneas de Nazca desde Paracas',
        category: 'Lima',
        url: 'pages/tour/Coast-of-Peru/Lima/tourFlightsOverNazcaLinesFromLima(1-dayVipPrivate).html',
    ...
    },
    {
        ...
        category: 'Líneas de Nazca',
        url: 'pages/tour/Coast-of-Peru/Nazca-Lines/tourPampasGalerasReserve.html',
    ...
    },
    {
        ...
        category: 'Líneas de Nazca',
        url: 'pages/tour/Coast-of-Peru/Nazca-Lines/tourFlightsOverNazca LinesFromLima(1-dayVipPrivate).html',
    ...
    // === Paracas y Islas Ballestas ===
    {
        ...
        url: 'pages/tour/Coast-of-Peru/Paracas-y-Islas-Ballestas/tourBikingParacas.html',
    ...
    },
    {
        ...
        category: 'Paracas y Islas Ballestas',
        url: 'pages/tour/Coast-of-Peru/Paracas-y-Islas-Ballestas/tourCruiseMemberIslasBallestasFirtsClass.html',
    ...
    },
    {
        ...
        category: 'Paracas y Islas Ballestas',
        url: 'pages/tour/Coast-of-Peru/Paracas-y-Islas-Ballestas/tourCruiseMemberIslasBallestasStandardTour.html',
    ...
    },
    {
        ...
        category: 'Paracas y Islas Ballestas',
        url: 'pages/tour/Coast-of-Peru/Paracas-y-Islas-Ballestas/tourParacasNationalReserve.html',
        image: 'assets/img/Costa/tours_Paracas/La_Reserva_Nacional_Paracas/tourReservaParacas.jpg'
    },
    {
        name: 'Tour Privado en Paracas',
        category: 'Paracas y Islas Ballestas',
        url: 'pages/tour/Coast-of-Peru/Paracas-y-Islas-Ballestas/tourPrivateTour.html',
        image: 'assets/img/Costa/tours_Paracas/Tour_Privado/TourPrivado.jpg'
    },
    {
        name: 'Alquiler de Yate en Paracas',
        category: 'Paracas y Islas Ballestas',
        url: 'pages/tour/Coast-of-Peru/Paracas-y-Islas-Ballestas/tourYachtCharter.html',
    ...
    // === Manu Reserve ===
    {
        ...
        url: 'pages/tour/Rainforest/Manu-Reserve/tourManuReserve.html',
    ...
    // === Tambopata Rainforest ===
    {
        ...
        url: 'pages/tour/Rainforest/Tambopata-Rainforest/tourManuReserve.html',
        image: 'assets/img/Selva_Tropical/Tambopata/ManuReserve/ReservaManu.jpg'
    },
    {
        name: 'Tambopata Reserve Tour',
        category: 'Tambopata Rainforest',
        url: 'pages/tour/Rainforest/Tambopata-Rainforest/tourTambopataReserve.html',
    ...
    // === Arequipa (The Highlands) ===
    {
        ...
        category: 'Arequipa',
        url: 'pages/tour/The-Highlands/Arequipa/tourArequipaCity.html',
        image: 'assets/img/SIerra/Arequipa/tour_Arequipa/tourArequipa.jpg'
    },
    {
        name: 'Colca Canyon Tour',
        category: 'Arequipa',
        url: 'pages/tour/The-Highlands/Arequipa/tourColcaCanyon.html',
    ...
    // === Lake Titicaca (The Highlands) ===
    {
        ...
        url: 'pages/tour/The-Highlands/Lake-Titicaca/tourLakeTiticacaBoat.html',
    ...
    // === Shore Excursions (Callao) ===
    {
        ...
        url: 'pages/ShoreExcursions/FromCallaoCruiseTerminal/tourShoreExcursionsLarcoMuseum.html',
    ...
    },
    {
        ...
        category: 'Cruceros desde Callao',
        url: 'pages/ShoreExcursions/FromCallaoCruiseTerminal/tourShoreExcursionstoPachacamacArchaeological.html',
    ...
    // === Shore Excursions (Salaverry) ===
    {
        ...
        url: 'pages/ShoreExcursions/FromSalaverryCruiseTerminal/tourShoreExcursionsChanChan.html',
    ...
    // === Shore Excursions (Pisco/Paracas) ===
    {
        ...
        url: 'pages/ShoreExcursions/FromTPPPiscoParacasCruiseTerminal/tourNazcaLinesFlight.html',
    ...
    },
    {
        ...
        category: 'Cruceros desde Pisco/Paracas',
        url: 'pages/FromTPPPiscoParacasCruiseTerminal/tourShoreExcursionsIslasBallestas.html',
    ...
    },
    {
        ...
        category: 'Cruceros desde Pisco/Paracas',
        url: 'pages/ShoreExcursions/FromTPPPiscoParacasCruiseTerminal/tourShoreExcursionsTamboColorado.html',
    ...
    // === Peru Packages (¡Añadidos aquí!) ===
    {
        ...
        url: 'pages/PeruPackages/MachuPicchuYTheSecretValleyofIncas/tourMachuPicchu&ValleyIncas.html',
    ...
    // MysetrioesOfTheSouthCoast(2Days/1 night) ===
    {
        ...
        url: 'pages/PeruPackages/MysetrioesOfTheSouthCoast/tourNazcaLinesFlightSouthCoast.html',
    ...
    },
    {
        ...
        category: 'MysetrioesOfTheSouthCoast',
        url: 'pages/PeruPackages/MysetrioesOfTheSouthCoast/tourUpgradeToVip.html',
    ...
    filteredList.forEach(city => {
        const cardHTML = `
            <a href="${window.pathPrefix}${city.url}" class="destination-item-card">
                <img src="${window.pathPrefix}${city.image}" alt="Destino: ${city.name}">
                <div class="city-name">
                    <span>${city.name}</span>
                </div>
            </a>
